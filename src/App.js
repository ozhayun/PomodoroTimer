  ...
  return (
    <div className="flex relative flex-col w-full min-h-screen">
      ...
      <div className="flex flex-col flex-grow lg:flex-row">
        <div className="flex flex-col justify-center items-center px-4 py-16 sm:px-6 lg:px-8 lg:w-3/4 lg:py-12">
      ...
      <footer className="py-4 mt-auto text-center">
        <a 
          ...
          className="text-sm transition-colors duration-200 text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200"
        >
